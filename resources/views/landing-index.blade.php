...
@section('contents')
        ...
        <div class="promo-content">
            <div class="promo-left">
                <div class="promo-left-texts">
                    <div class="text-code"><img src="/assets/img/promo/code-1.png" alt=""><img
                            src="/assets/img/promo/code-2.png" alt=""><img src="/assets/img/promo/code-3.png" alt="">
                    </div>
                    ...
                    <a id="stack" href="#anchor-project">
                        <button class="btn-cases">Our cases</button>
                    </a>
                </div>
            </div>
    ...
    <div class="about-title-block">
        <div class="custom-container">
            ...
            <div class="text">
                <p>Our mission is to create innovative and scalable software applications that handle large volumes of
                    data requests and backend computations.
                    We leverage best development practices to ensure that each platform functions properly and is
                    available without interruptions.</p>
            </div>
        </div>
    </div>
        ...
        <div class="custom-container">
            ...
            <div class="about-block gray-back">
                ...
                <div class="about-block-text">
                    ...
                    <div class="text">
                        <p>We produce low-code services that optimize operational processes for SaaS businesses and
                            large Enterprises. Companies save hours spent on development by using ready-to-use features
                            tailored for business analytics, customer service, and subscription management.</p>
                    </div>
                </div>
            </div>
            <div class="about-block desktop-reverse">
                ...
                <div class="about-block-text">
                    ...
                    <div class="text">
                        <p>We design a Сloud cost optimization platforms for heads of IT departments, Financial teams,
                            and Company owners. These solutions provide granular visibility on numerous resources’
                            consumption and cost rates for making balanced managerial decisions. </p>
                    </div>
                </div>
            </div>
        </div>
